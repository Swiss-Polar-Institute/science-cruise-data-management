...
rsync -r -l -z -t --delete --delete-excluded --filter='+ */' --filter='-*.pyc' requirements.txt /var/www/vhosts/scdm.epfl.ch/private/ScienceCruiseDataManagement/requirements.txt
...
pip install -r /var/www/vhosts/scdm.epfl.ch/private/ScienceCruiseDataManagement/requirements.txt
