...
class OutreachActivity(models.Model):
    ...
    activity_location_event_link = models.CharField(help_text="Please give a weblink to the outreach activity if available.", blank=True, null=True)
    ...
    audience_size = models.ForeignKey(AudienceSize, "Please estimate the size of the audience reached by your outreach activity.")
    audience_type = models.ManyToManyField(AudienceType, "Please give an idea of the type of audience at which your activity was aimed.")
    media_type = models.ManyToManyField(MediaType, "Please select the main types of media used during your outreach activity.")
