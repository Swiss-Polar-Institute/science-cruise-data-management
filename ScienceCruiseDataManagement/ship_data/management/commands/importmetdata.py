        ...
        with open(filename) as csvfile:
            ...
            for row in reader:
                if (len(row) == 59) and line_number != 0:
                    d = {}
                    (d['TIME'], LAT, LAT_NS, LONG, LONG_EW, d['WD2MA1'], d['WD2MM1'], d['WD2MX1'], d['WS2MA1'], d['WS2MM1'], d['WS2MX1'], d['WD10MA1'], d['WD10MM1'], d['WD10MX1'], d['WS10MA1'], d['WS10MM'], d['WS10MX1'],
                    ...
                    outcome = utilities.check_lat_lon_direction(self, LAT_NS, LONG_EW)
                    if outcome==True:
                        ...
                        print("Row skipped, invalid NS or EW: ", d)

                elif (len(row) == 16) and line_number != 0:
                    d = {}
                    (d['TIME'], d['COG'], d['HEADING'], d['WDR1'], d['WSR1'], d['WD1'], d['WS1'], d['WDR2'], d['WSR2'], d['WD2'], d['WS2'], d['TIMEDIFF'], Year, Month, DAY, d['CLOUDTEXT']) = row
