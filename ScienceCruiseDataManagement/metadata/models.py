...
class MetadataEntry(models.Model):
    ...
    data_center = models.ManyToManyField(DataCenter, default=metadata_entry_data_center_defaults, related_name='data_center_provider', help_text="The <Data Center> is the data center, organization, or institution responsible for distributing the data.")
