...
class MetadataEntry(models.Model):
    ...
    data_set_citation = models.ManyToManyField(DataSetCitation)
    ...
    sensor_name = models.ManyToManyField(Instrument)
    source_name = models.ManyToManyField(Platform)
    temporal_coverage = models.ManyToManyField(TemporalCoverage)
    data_set_progress = models.ForeignKey(DatasetProgress, null=True, blank=True)
    spatial_coverage = models.ManyToManyField(SpatialCoverage)
    location = models.ManyToManyField(Location)
    data_resolution= models.ManyToManyField(DataResolution)
